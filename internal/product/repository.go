...
type Repository interface {
	...
	ExistsById(ctx context.Context, productId int) bool
...
func (r *repository) ExistsById(ctx context.Context, productId int) bool {
	sqlStatement := `SELECT id FROM "main"."products" WHERE id=$1;`
